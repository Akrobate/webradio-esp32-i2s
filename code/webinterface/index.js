...
async function loadInfoAndWifiStatusData() {
    ...
    $('.connection-status', _el_block_wifi_status).textContent = info.is_connected_to_wifi ? 'Connected' : 'Disconnected'
    ...
    $('.temperature', _el_block_info).textContent = info.temperature
    $('.pressure', _el_block_info).textContent = info.pressure
